...
public class ManagerFlightDeleteService extends AbstractGuiService<AirlineManager, Flight> {
	...
	public void authorise() {
		...
		if (flight != null)
			authorised = super.getRequest().getPrincipal().hasRealm(flight.getAirlineManager()) && !flight.getPublished() && flight.getAirlineManager().getId() == managerId;
	...
	public void validate(final Flight flight) {
		...
		super.state(legs.isEmpty(), "*", "manager.flight.error.flight-has-legs");
	}
