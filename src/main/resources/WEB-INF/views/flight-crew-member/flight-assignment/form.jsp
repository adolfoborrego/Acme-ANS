...
<jstl:choose>
    ...
    <jstl:when test="${_command == 'show'}">
        <acme:form readonly="false">
            ...
            <%-- Campo Remarks, diferenciando seg�n Fid e id --%>
            <jstl:if test="${Fid != id}">
                <acme:input-textbox readonly="true"
            ...
            <%-- Botones de acci�n (solo si el vuelo a�n no est� publicado/aterrizado y Fid coincide) --%>
    ...
    <jstl:when test="${_command == 'addFlightAssignment'}">
        <acme:form readonly="false">
            ...
            <%-- Campo de selecci�n de Crews, espec�fico de addFlightAssignment --%>
            <acme:input-select readonly="false"
            ...
            <%-- Bot�n para crear asignaci�n de vuelo en addFlightAssignment --%>
    ...
    <jstl:when test="${_command == 'create'}">
        <acme:form readonly="false">
            ...
            <%-- Bot�n para crear asignaci�n --%>
            <acme:submit code="flight-crew-member.flight-assignment.create"
                action="/flight-crew-member/flight-assignment/create" />
        </acme:form>
    </jstl:when>

    <%-- Bloque para los dem�s comandos (por ejemplo, update) --%>
    <jstl:otherwise>
        <acme:form readonly="false">
            ...
            <%-- Botones de acci�n si se cumple la condici�n de vuelo no publicado/aterrizado y Fid coincide --%>
